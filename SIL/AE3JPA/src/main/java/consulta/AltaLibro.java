...
public class AltaLibro {
    ...
    public static void main(String[] args) {
        ...
        libro1.setTitulo("El templo de Salomón");
        libro1.setPrecio(25); 
        ...
        libro3.setTitulo("La sombra del Chamán");
        libro3.setPrecio(25); 
        ...
        libro4.setTitulo("El niño del pijama de rayas");
        libro4.setPrecio(25); 
        ...
        libro5.setTitulo("El viaje al poder de la mente");
        libro5.setPrecio(25); 
        ...
        libro6.setTitulo("La estacion de los aromas");
        libro6.setPrecio(25); 
        ...
        libro7.setTitulo("La metamorfisis de Kafka");
        libro7.setPrecio(25); 
        ...
        libro8.setTitulo("Entre Oriente y Occidente");
        libro8.setPrecio(25); 
